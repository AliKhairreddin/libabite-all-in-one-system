...
import { MINUTE_MS, UNPAID_PAYMENT_METHOD, VAT_RATES, TICKET_SLA_MINUTES, SLA_WARNING_WINDOW_MINUTES, KITCHEN_STATIONS, VAT_OPTIONS, UNIT_TYPES, DEFAULT_INVENTORY_LOCATIONS, INVENTORY_ACTIONS, DEFAULT_RECIPE_ORDER_CONTEXT, ROLE_DEFINITIONS } from "./shared/constants.js";
...
import { getDefaultProductionProductId as getDefaultProductionProductIdFromList, getProductionExecutionDraft as getProductionExecutionDraftFromValues, getProductionFieldName, getProductionOutputDefault, getProductionOutputUnitType as getProductionOutputUnitTypeForIngredient, getProductionProducts as getProductionProductsFromList, getProductionReadiness as getProductionReadinessForDraft, roundMoneyValue } from "./domain/production.js";
import { getAvailableReservationTable as getAvailableReservationTableFromList, getReservationConflicts as getReservationConflictsFromList, getReservationIssues as getReservationIssuesFromList, getReservationValidation as getReservationValidationFromList, getReservationWindowLabel } from "./domain/reservations.js";
...
import { formatDateTime, formatDateTimeLocalInput, formatDuration, timeNow } from "./shared/dates.js";
...
const { assignQrCode, createTableQrCode, getCustomerOrderingSession, getCustomerQrSession, getQrOrderUrl, getStaffUrl, getWebsiteOrderSession, openQrCustomerUrl, regenerateQrCode, toggleQrCode } = createQrRuntime({
    can,
    render: () => render(),
    showToast,
    tableById
