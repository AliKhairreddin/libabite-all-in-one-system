...
export function createTeamUi(deps) {
    ...
    const { can, canManageDeliveryOperations, currentDriverRecord, currentRoleKey, currentUser, currentUserCanUpdateDelivery, driverById, emptyState, getOrderPaymentSummary, orderById, orderItemDetailText, productById, roleDefinition } = deps;
