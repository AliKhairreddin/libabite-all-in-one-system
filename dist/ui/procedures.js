...
import { LANGUAGE_OPTIONS, PROCEDURE_ASSIGNED_ROLES, PROCEDURE_COMPLETION_STATUSES, PROCEDURE_DEPARTMENTS, PROCEDURE_FREQUENCIES } from "../shared/constants.js";
import { procedureAssignedToUser as procedureAssignedToUserByRole, procedureFrequencyWindowMs, procedureStatusClass } from "../domain/procedures.js";
...
export function createProceduresUi(deps) {
    ...
    const { can, currentRole, currentUser, emptyState, formatActualUsageLabel, formatSignedAmount, formatStockAmount, getAllInventoryLocations, getDefaultProductionProductId, getLineCost, getProductMargin, getProductionExecutionDraft, getProductionFieldName, getProductionOutputDefault, getProductionOutputUnitType, getProductionProducts, getProductionReadiness, getRecipeLineQuantity, getRecipeLineWasteMultiplier, getRecipeMeasure, getRecipeUsageLabel, getWasteUnitOptionsForIngredient, ingredientById, money, productById, roleDefinition, unitTypeDefinition } = deps;
