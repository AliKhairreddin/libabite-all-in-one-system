...
export function createKitchenUi(deps) {
    ...
    const { can, emptyState, getKitchenSlaSummary, getOpenTickets, getStationNames, getTicketOrderAgeMinutes, getTicketPriority, getTicketSla, getTicketStatusLabel, orderById, orderLocationLabel, orderTypeLabel, productById, ticketStatusClass } = deps;
