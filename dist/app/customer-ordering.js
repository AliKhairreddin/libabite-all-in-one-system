import { CUSTOMER_QR_CHANNEL, CUSTOMER_QR_ORDER_CONTEXT, UNPAID_PAYMENT_METHOD, WEBSITE_ORDER_CHANNEL, WEBSITE_PAYMENT_PROCESSOR } from "../shared/constants.js";
...
export function createCustomerOrderingRuntime(deps) {
    const { getCustomerOrderingSession, getCustomerQrSession, getWebsiteOrderSession, getProductAvailability, getStockShortages, getItemsTotal, normalizeOrderItems, productById, render, renderCustomerQrScreen, renderWebsiteOrderScreen, sendOrderToKitchen, showToast, upsertCustomerFromOrderDetails, validateOrderForKitchen } = deps;
...
//# sourceMappingURL=customer-ordering.js.map