import { AVAILABILITY_OPTIONS, DEFAULT_MARGIN_MINIMUM, DEFAULT_MARGIN_TARGET, PRODUCT_CATEGORIES, VAT_OPTIONS } from "../shared/constants.js";
import { normalizeKitchenStation, normalizeMarginPercent, normalizeRecipeAppliesTo, normalizeRecipeLine, normalizeRecipeLines, normalizeRecipeWastePercent, unitTypeDefinition } from "../data/normalize.js";
import { uniqueRecordId } from "../shared/ids.js";
import { saveState, state } from "./state.js";
export function createProductActionsRuntime(deps) {
    const { can, getRecipeLineQuantity, getRecipeMeasure, getSelectedInventoryLocation, ingredientById, productById, pushInventoryHistory, rememberInventoryLocation, render, showToast } = deps;
