...
import { normalizeListInput, normalizeProcedureAssignedRole, normalizeProcedureDepartment, normalizeProcedureFrequency, normalizeProcedureLanguage, normalizeProcedureMedia, normalizeProcedureSteps } from "../data/normalize.js";
...
export function createProcedureActionsRuntime(deps) {
    const { can, currentUser, getProcedureStepProgress, procedureAssignedToUser, procedureById, procedureStepsComplete, render, roleDefinition, showToast } = deps;
...
//# sourceMappingURL=procedure-actions.js.map