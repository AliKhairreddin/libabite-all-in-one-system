...
import { getApplicableCapacityRules as getApplicableCapacityRulesFromList, getAvailableReservationTable as getAvailableReservationTableFromList, getReservationBlockConflicts as getReservationBlockConflictsFromList, getReservationCapacityIssue as getReservationCapacityIssueFromList, getReservationConflicts as getReservationConflictsFromList, getReservationIssues as getReservationIssuesFromList, getReservationRequestValidation as getReservationRequestValidationFromList, getReservationValidation as getReservationValidationFromList } from "../domain/reservations.js";
...
export function getReservationIssues(reservation) {
    return getReservationIssuesFromList(reservation, state.tables, state.reservations, RESERVATION_TURNOVER_MINUTES, state.reservationBlocks, state.reservationCapacityRules);
}
export function getReservationValidation(candidate) {
    return getReservationValidationFromList(candidate, state.tables, state.reservations, RESERVATION_TURNOVER_MINUTES, state.reservationBlocks, state.reservationCapacityRules);
}
export function getReservationRequestValidation(candidate) {
    return getReservationRequestValidationFromList(candidate, state.tables, state.reservations, state.reservationBlocks, state.reservationCapacityRules, RESERVATION_TURNOVER_MINUTES);
}
...
//# sourceMappingURL=reservation-selectors.js.map