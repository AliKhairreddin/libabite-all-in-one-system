import { DEFAULT_RECIPE_ORDER_CONTEXT, UNPAID_PAYMENT_METHOD, VAT_OPTIONS, VAT_RATES } from "../shared/constants.js";
import { state } from "./state.js";
import { driverById, money, productById, tableById, userNameById } from "./entities.js";
...
import { calculateItemsTotal, calculateOrderTotal, countOrderItems, normalizeOrderFulfillment, normalizeOrderItems as normalizeOrderItemsForProducts, normalizeOrderType, orderTypeDefinition, productCanBeOrdered, productCanBeOrderedForOrderContext } from "../domain/orders.js";
...
export function getOrderFulfillmentMeta(order) {
    ...
    if (order.externalStatusPushedAt)
        details.push(`Platform status: ${order.externalStatus || "updated"}`);
    return details;
}
